...
function DriverViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<DriverInterface>(
    ...
    () =>
      getDriverById(id, {
        relations: ['user', 'vehicle_driver_vehicle_idTovehicle'],
      }),
  );
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                {hasAccess('vehicle', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Vehicle Driver Vehicle Id Tovehicle"
                    text={
                      <Link as={NextLink} href={`/vehicles/view/${data?.vehicle_driver_vehicle_idTovehicle?.id}`}>
                        {data?.vehicle_driver_vehicle_idTovehicle?.id}
                      </Link>
                    }
                  />
                )}
