...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  async function createVehicle() {
    ...
    if (body?.driver_driver_vehicle_idTovehicle?.length > 0) {
      const create_driver_driver_vehicle_idTovehicle = body.driver_driver_vehicle_idTovehicle;
      body.driver_driver_vehicle_idTovehicle = {
        create: create_driver_driver_vehicle_idTovehicle,
      };
    } else {
      delete body.driver_driver_vehicle_idTovehicle;
    }
