...
import { getPassengers, deletePassengerById } from 'apiSdk/passengers';
...
export function PassengerListPage(props: PassengerListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<PassengerInterface>>(
    () => `/passengers?params=${JSON.stringify(params)}`,
    fetcher,
  );
